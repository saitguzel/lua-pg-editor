#!/bin/sh
# Yedekten geri yükleme + doğrulama (F18). Kullanım: restore.sh /backups/daily/pgeditor-....dump[.age]
...
PGUSER=${PGUSER:-pgeditor}
PGDATABASE=${PGDATABASE:-pgeditor}
...
echo "connections: $(q 'SELECT count(*) FROM connections;')"
