...
describe("types", function()
  ...
  it("PAGES 18 eleman", function()
    assert.equal(18, #types.PAGES)
    assert.equal("dashboard", types.PAGES[1])
    assert.equal("settings", types.PAGES[18])
  end)
  ...
  it("AUDIT_ACTIONS 34 eleman", function()
    assert.equal(34, #types.AUDIT_ACTIONS)
  end)
  it("default_matrix 36 hücre ve valid", function()
    local m = types.default_matrix()
    assert.equal(36, #m.permissions)
