...
function _M.insert(entry)
  return query.exec(
    [[INSERT INTO audit_logs (request_id, user_id, user_email, action, entity_type, entity_id, old_value, new_value,
      ip, ip_address, user_agent, status, error_message)
      VALUES ($1::uuid, $2, $3, $4, $5, $6, $7::jsonb, $8::jsonb, $9::inet, $9::inet, $10, $11, $12)]],
    entry.request_id, entry.user_id, entry.user_email, entry.action, entry.entity_type, entry.entity_id,
    entry.old_value, entry.new_value, entry.ip_address or entry.ip, entry.user_agent, entry.status, entry.error_message
  )
end
