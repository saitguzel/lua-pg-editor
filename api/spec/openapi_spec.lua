...
describe("openapi spec", function()
  ...
  setup(function()
    ...
    -- ensure clean reload
    package.loaded["openapi.spec"] = nil
  ...
  it("servers[0].url APP_BASE_URL'ye gore degisir", function()
    assert.truthy(spec.servers[1].url:find("28080"))
  end)

  it("tags tanimli", function()
    assert.truthy(#spec.tags >= 6)
  end)
end)
