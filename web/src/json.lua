...
-- glue.js dizi içindeki null'ları bu işaretle döndürür (nesne alanındaki null → nil)
local NULL_MARK = "\1pg:null\1"

local function restore_nulls(t)
  for k, v in pairs(t) do
    if v == NULL_MARK then t[k] = json.null
    elseif type(v) == "table" then restore_nulls(v) end
  end
end
...
function json.decode(s)
  ...
  if type(res) == "table" and s:find("null", 1, true) then restore_nulls(res) end
  return res
end
